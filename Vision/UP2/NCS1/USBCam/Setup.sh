...
if [ ! -f "GeniSysAI/Vision/UP2/NCS1/USBCam/Model/inception_resnet_v1.py" ]
then
...
cd GeniSysAI/Vision/UP2/NCS1/USBCam/Model/20170512-110547
...
then
    ...
    cd GeniSysAI/Vision/UP2/NCS1/USBCam/Model/20170512-110547/facenet_celeb_ncs
...
cd GeniSysAI/Vision/UP2/NCS1/USBCam/Model/dlib
