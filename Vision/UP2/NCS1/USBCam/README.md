...
User=YourUser
Type=simple
ExecStart=/usr/bin/python3 /home/YourUser/GeniSysAI/Vision/UP2/NCS1/Standard/USBCam/Camera.py
...
● api.service - GeniSysAI USB Camera Security System
 ...
 Main PID: 3481 (python3)
   ...
   CGroup: /system.slice/Camera.service
           └─3481 /usr/bin/python3 /home/YourUser/GeniSysAI/Vision/UP2/NCS1/Standard/USBCam/Camera.py
```
